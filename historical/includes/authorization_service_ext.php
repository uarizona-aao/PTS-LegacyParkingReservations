<?php
/*
 * authorization_service_ext.php (this file gonna replace authorization_service.php some day!)
 * User authorization for the PTS Service Request application
 */

require_once '/var/www2/include/gr/authorization.php';
...
// private $phonebook_entry;
    ...
    protected function test_login($username, $password) {
		...
		$this->set_authorized(); // same as $this->authorized
