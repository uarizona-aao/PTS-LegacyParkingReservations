...
$unavailable = false;
if ($unavailable) {
	echo "<div style=\"text-align:center;\"><b>The Visitor Reservations system is currently unavailable.</b><br/>If you need to make a reservation, please contact PTS Visitor Programs at 621-3710.</div>\n";
...
function get_garage() {
    ...
    $pop->set_id_link('name', 'daily_listing.php');
    $pop->populate();
