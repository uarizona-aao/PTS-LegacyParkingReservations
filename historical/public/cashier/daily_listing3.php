...
function get_daily() {
	...
	// query is safe!
	$db->query("SELECT COUNT(EX_ID) AS TALLY FROM PARKING.GR_GUEST_EXCEPTION WHERE TRUNC(EX_TIME)=(TRUNC(SYSDATE))-1 AND EX_GARAGE_FK=$garage");
