...
<?php
require_once '../reservations_day.php';
backlink('index.php');

function get_placement() {
    $form = new form('Show Reservations Placed On');
    ...
    $form->add(field_factory::get_item_row(new collection($view, $back)));
    $results = $form->get_xml();

    if(!isset($_POST['Date'])) return $results;
    $date = date('d-M-y', strtotime($_POST['Date']));
    $results .= get_reservation_list($date)->get_xml();
    return $results;
}
?>
