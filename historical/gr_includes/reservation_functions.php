...
// generates a receipt page based on the reservation information (currently, the user is redirected to the reservation view)
function generateResReceipt ($conf) {
	// global database var
	global $dbConn;
